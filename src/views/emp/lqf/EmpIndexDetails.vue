      ...
      AMapLoader.load({
        ...
        .then((AMap) => {
          ...
          var marker = new AMap.Marker({
            position: [this.data.jingdu, this.data.weidu], //不同标记点的经纬度
            map: map,
          });
          //内部样式
          marker.content = `<div style="width: 180px; height: 20px;"><span onclick="tmap()"> 工作地点：英雄广场</span>
           </div>
        `;
          ...
          console.log("经纬度数据：", this.data.jingdu, this.data.weidu);
        })
        .catch((e) => {
          console.log(e);
        });
