...
<van-nav-bar>
  ...
  <template #right>
    ...
    &nbsp;&nbsp;
     ...
     <!-- 在线简历以及图片 -->
     <div class="tp">
     <router-link to="/empme_me" style="color: aliceblue;font-size: 18px;">在线简历<van-icon name="arrow" /></router-link>
     <router-link to="/empxg" v-if="empurl"> <img class="tx" :src="data.url" alt=""> </router-link>
     <router-link to="/empxg" v-else><img class="img1" src="/1.png" alt=""></router-link>
     </div>
     <!--标签 -->
...
<van-cell title="求职意向" icon="envelop-o" style="font-size:20px" is-link value="求职中">
   <template #right-icon>
    <van-icon name="arrow"/>
  </template>
</van-cell>
...
<van-cell title="附件简历" icon="todo-list-o" style="font-size:20px" is-link value="去上传">
   <template #right-icon>
    <van-icon name="arrow"/>
  </template>
</van-cell>
<van-cell title="家的位置" icon="wap-home-o" style="font-size:20px" is-link value="去设置">
   <template #right-icon>
    <van-icon name="arrow"/>
  </template>
</van-cell>
<van-cell title="我的职Q" icon="chat-o" style="font-size:20px" is-link value="已发布的动态">
   <template #right-icon>
    <van-icon name="arrow"/>
  </template>
</van-cell>
...
<van-row type="flex" justify="space-around" style="text-align: center;font-size:12px;margin-top: 10px;">
