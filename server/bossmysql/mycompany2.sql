...
--
-- Host: 127.0.0.1
-- Generation Time: 2022-06-24 09:11:54
...
CREATE TABLE `mycompany2` (
  ...
  `bossname` varchar(32) NOT NULL COMMENT '用户名'
...
INSERT INTO `mycompany2` (`nid`, `name`, `introduct`, `position`, `currentDate`, `money`, `nid_id`, `bossname`) VALUES
...
(4, '阿里巴巴(中国)网络技术有限公司', 'HR·严先生', '\r\n浙江省杭州市滨江区', '1999-09-09', 1, 10, '123321');
